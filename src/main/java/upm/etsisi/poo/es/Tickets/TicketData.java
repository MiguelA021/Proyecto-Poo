...
public class TicketData {
     ...
     * @return returns true if the ticket has been added successfully, else returns
     * false
     */
    ...
    public void csvTickets(CSVRecord record, int[] ticketActual) {
        if (!record.get(0).equals("EnterpriseMixedTicket") && !record.get(0).equals("CustomerTicket")
                && !record.get(0).equals("EnterpriseServiceTicket")) {
                        ...
                        switch (record.get(1)) {
                            case "PersonalizedProduct":
                                PersonalizedProduct p = new PersonalizedProduct(Integer.parseInt(record.get(2)), record.get(3),
                                        upm.etsisi.poo.es.type.valueOf(record.get(4)), Double.parseDouble(record.get(5)),
                                ...
                                break;
                            case "BasicProduct":
                                BasicProduct b = new BasicProduct(Integer.parseInt(record.get(2)), record.get(3),
                                        upm.etsisi.poo.es.type.valueOf(record.get(4)),
                                        Double.parseDouble(record.get(5)));
                                ((CustomerTicket) ticket).ticketAddNoString(b, 1);
                                break;
                            case "Meeting":
                                Meeting m = new Meeting(Integer.parseInt(record.get(2)), record.get(3),
                                        Double.parseDouble(record.get(4)), record.get(5));
                                ((CustomerTicket) ticket).ticketAddNoString(m, 1);
                                break;
                            case "Food":
                                Food f = new Food(Integer.parseInt(record.get(2)), record.get(3), Double.parseDouble(record.get(4)),
                                        record.get(5));

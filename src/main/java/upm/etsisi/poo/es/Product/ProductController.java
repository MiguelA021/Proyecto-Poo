...
public class ProductController {
    ...
    public void renovateInventory(CSVRecord csvRecord, boolean[] cont) {
        ...
        if (!csvRecord.get(0).equals("Products") && cont[0]) {
            ...
            switch (type) {
                ...
                case "PersonalizedProduct":
                    try {
                        PersonalizedProduct basicProduct = new PersonalizedProduct(Integer.parseInt(csvRecord.get(1)),
                                csvRecord.get(2),
                                upm.etsisi.poo.es.type.valueOf(csvRecord.get(3)), Double.parseDouble(csvRecord.get(4)),

...
public class CashierController {
    ...
    private CashierController() {
        this.cashierDAO = CashierDAO.getInstance();
        this.cashers = cashierDAO.loadCashiers();
    }
    ...
    public boolean removeCasher(int id) {
        Cashier cashierRemoved = cashers.remove(id);
        if (cashierRemoved != null) {
            cashierDAO.removeCashier(cashierRemoved);
        }
        return cashierRemoved != null;
    }
